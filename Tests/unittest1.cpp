...
namespace Tests
{
	...
	public:
		TEST_METHOD(Plane_Out)
		{
			...
			ofst.close();
			string test_string;
			ifstream iffst("C:\\Users\\���������\\Desktop\\Github\\����� �����\\ConsoleApplication1\\ConsoleApplication1\\fileout.txt");

			getline(iffst, test_string);
			string expected_string = "It is Plane: ���������������� = 1000, ��������� ������ = 1, ���� � ������ ������ = 187";
			Assert::AreEqual(expected_string, test_string);
		};
		TEST_METHOD(Traine_Out)
		{
			ifstream ifst("C:\\Users\\���������\\Desktop\\Github\\����� �����\\ConsoleApplication1\\ConsoleApplication1\\filein.txt");
			transport *test = In(ifst);
			test = In(ifst);
			ofstream ofst("C:\\Users\\���������\\Desktop\\Github\\����� �����\\ConsoleApplication1\\ConsoleApplication1\\fileout.txt");
			...
			getline(iffst, test_string);
			string expected_string = "It is Traine: ���-�� ������� = 30";
			Assert::AreEqual(expected_string, test_string);
		};
		TEST_METHOD(Ship_Out)
		{
			...
			getline(iffst, test_string);
			string expected_string = "It is Ship: ������������� = 3, ��� ����� = TUG";
			Assert::AreEqual(expected_string, test_string);
		};
		...
		TEST_METHOD(Container_Out)
		{
			...
			expected_string = "1: It is Traine: ���-�� ������� = 30, ���������� ����� �������� = 8000, �������� = 80";
			getline(iffst, test_string);
			Assert::AreEqual(expected_string, test_string);
			...
			expected_string = "3: It is Ship: ������������� = 3, ��� ����� = TUG, ���������� ����� �������� = 700, �������� = 700";
			getline(iffst, test_string);
			Assert::AreEqual(expected_string, test_string);
